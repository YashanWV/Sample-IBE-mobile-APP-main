...
function HomeScreen2({ route, navigation }) {
  ...
  const [bookingss, setBookingss] = useState(null);
  // const { refresh } = route.params || {};

  // useFocusEffect(
  //   useCallback(() => {
  //     // Refresh or fetch data when screen comes into focus
  //     if (refresh) {
  //       // Logic to refresh data or re-render the component
  //     }
  //   }, [refresh])
  // );
  ...
  //   const response = await bookings.getBookings(username);

  //   console.log(response.data);
  //   setBookingss(response.data);
  // };
      ...
      <AppBackground>
        ...
        <View style={styles.bookingsButtonContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("PreviousBookingsScreen", {
                params: bookingss,
              })
            }
          >
      ...
      >
        <View style={styles.modalOverlay}>
          <AppBackgroundCardView style={styles.container}>
            ...
            >
              <FontAwesome name="close" size={15} color={colors.lightgrey} />
            </TouchableOpacity>
