...
import { View, StyleSheet, Text, Platform, Image, TouchableOpacity, TouchableHighlight, Modal, Pressable, Keyboard } from "react-native";
        ...
        <>
            <View style={styles.header}>
                ...
                {userDetails ? (
                    ...
                    <TouchableOpacity style={styles.loginButton} onPress={() => setShowLoginCard(true)}>
                ...
                <View style={styles.modalOverlay}>
                    ...
                    <AppBackgroundCardView style={styles.container}>
                        ...
                        >
                            ...
                            <AppText
                                style={{ fontSize: 16, color: colors.secondary, fontWeight: "500" }}
                            >
                                Not registered yet?
                            </AppText>
                        ...
                        <AppButton title={"REGISTER"} onPress={() => {
                            ...
                            setShowLoginCard(false);
                        }} color="tertiary" marginBottom={25} />
