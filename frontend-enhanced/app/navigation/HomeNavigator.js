...
const HomeNavigator = () => (
    <Stack.Navigator initialRouteName='HomeScreen2'>
        ...
        <Stack.Screen name='RegisterScreen' component={RegiterScreen} options={{
            title: 'REGISTER', headerTitleAlign: 'center', headerStyle: styles.headerStyle, headerTitleStyle: styles.headerTitleStyle, headerBackTitleVisible: false, headerBackImage: () => (
